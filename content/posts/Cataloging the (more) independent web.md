...
As I venture further out into the corners of the indieweb and fediverse, I find that traditional search engines are not providing a good means of discovery. Let's go back to the old ways of directories and web portals.

Below is a meta-directory of directories. Including some directories of other directories - it's directories all the way down.
...
## Fediverse Portals and Info Sites

- https://fediverse.party/
- https://the-federation.info/

## Independent Software Forge Instances

- https://codeberg.org/forgejo-contrib/delightful-forgejo#public-instances

## Minimalist Site Clubs
...
- https://www.brisray.com/web/indiedirs.htm
- https://www.brisray.com/web/webring-list.htm
...
- https://nekoweb.org/explore?page=1&sort=follows&by=name&q=
